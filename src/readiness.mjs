export const gates = Object.freeze({
  ...
  B: { state: 'hardware_required', label: 'local_vertical_slice', evidence: 'Host/simulated verification passes; reviewed observation-resilience code still requires native build/install and real-device acceptance.' },
...
export function readinessReport() {
  ...
  return {
    ...
    next_action: complete ? null : 'Build/package the reviewed executor candidate, obtain owner deployment approval, then run the documented real-device gate-B acceptance sequence.',
    invariant: 'Host or simulated success never upgrades a hardware gate.'
  };
}
